...
class Mail(models.Model):
    ...
    mail_status = models.CharField(max_length=40, verbose_name='статус рассылки',
    ...
    next_time_mailing = models.DateTimeField(verbose_name='следующее время рассылки', **NULLABLE)
...
class MailingLog(models.Model):
    ...
    status = models.CharField(max_length=20, choices=STATUSES, verbose_name='статус последней попытки рассылки')
